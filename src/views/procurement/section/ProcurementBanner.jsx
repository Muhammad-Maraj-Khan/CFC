...
import ProcurementBannerImage from "assets/images/procurement-laptop-full.png";
      ...
      <div className="home-banner-container">
        <Row gutter={[30, 0]}>
          <Col xl={12} lg={12} md={24} sm={24} xs={24} className="home-content">
            <div className="teaching-sub-header">Procurement</div>
            <div className="home-banner-header fade-in-header">
              Automate, Reduce Costs and Achieve Better Outcomes
            </div>
            <div className="home-banner-text fade-in-text">
              Our solutions empower procurement teams to work smarter, not
              harder, by automating routine tasks, improving accuracy, and
          ...
          <Col xl={12} lg={12} md={24} sm={24} xs={24} className="home-img-col">
            <img src={ProcurementBannerImage} />
          </Col>
        </Row>
      </div>
    </Wrapper>
